  ...
  return (
    <div className="flex flex-col gap-3">
      <button
        ...
        className="flex w-full items-center justify-center gap-2 rounded-full border border-white/10 bg-[#1a1a1a] px-4 py-3.5 text-[15px] font-bold text-amber-500 transition-all hover:border-amber-500/50 hover:bg-white/5 active:scale-95"
      >
        ...
        <div className="animate-in fade-in slide-in-from-top-2 rounded-2xl border border-white/10 bg-[#1a1a1a] p-4 text-sm text-neutral-300">
          ...
          <ol className="flex flex-col gap-3">
            <li className="flex items-center gap-2">
              1. Appuyez sur l&apos;icône <Share className="size-5 text-blue-400" />{" "}
              dans Safari
            </li>
            <li className="flex items-center gap-2">
